...
SQLALCHEMY_DATABASE_URL = f'postgresql+psycopg2://{settings.database_username}:{settings.database_password_company}@{settings.database_hostname_company}:{settings.database_port}/{settings.database_name}'
